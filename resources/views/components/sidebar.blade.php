<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        @php
            $PermissionDasboard = App\Models\PermissionRole::getPermission('Dashboard', Auth::user()->role_id);
            ...
            $PermissionCampaign = App\Models\PermissionRole::getPermission('Campaign', Auth::user()->role_id);
            $PermissionDonatur = App\Models\PermissionRole::getPermission('Donatur', Auth::user()->role_id);
        ...
        @if (!empty($PermissionCampaign))
            <li class="nav-item">
                <a class="nav-link @if (Request::segment(2) != 'campaign') collapsed @endif"
                    href="{{ url('panel/campaign') }}">
        ...
        @if (!empty($PermissionFundraiser))
            <li class="nav-item">
                <a class="nav-link @if (Request::segment(2) != 'fundraiser') collapsed @endif"
                    href="{{ url('panel/fundraiser') }}">
        ...
        @if (!empty($PermissionKeuangan))
            <li class="nav-item">
                <a class="nav-link @if (Request::segment(2) != 'keuangan') collapsed @endif"
