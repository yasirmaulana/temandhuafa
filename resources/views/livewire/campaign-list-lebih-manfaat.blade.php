<div class="section full mb-3">
    <div class="row">
      ...
      <div class="col-4 text-right pr-3">
        <a href="program.html"><h6 class="text-primary">Lihat Semua</h6></a> 
      </div>
    </div>
    ...
    <div class="card mb-1">
        <a href="/fundraiser/{{ $campaign->fundraiser_id }}">
            ...
            <div class="card-body pt-2">
                ...
                <h5 class="text-primary" style="font-weight:bold">{{ $campaign->fundraiser }}</h5>
                <h6 class="mb-0 text-secondary">Total Penghimpunan</h6>
                <h5>Rp {{ number_format($campaign->total_gross_amount, 0, ',', '.') }}</h5>
